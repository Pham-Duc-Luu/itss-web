  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-7 max-w-md w-full flex flex-col">
        ...
        <Button type="submit" className="bg-white-400 text-purple-500 hover:bg-purple-500 hover:text-white rounded-full border-2 border-purple-500">Create account</Button>
      </form>
    </Form>
  )
}
