  ...
  return (
        ...
        <div className=''>
            ...
            <div className='flex gap-3'>
                <Star size={25}/>
                <h2 className='font-medium text-gray-500 text-lg'>{collection.rate} ({collection.number_of_rate} rate)</h2>
            </div>
        </div>
        <div className=''>
        ...
        <div className=''>
            ...
            <div className="flex flex-col gap-5">
                {collection.flashcard.map((word,i) => <WordCard key={i} word={word}/>)}
            </div>
        </div>
