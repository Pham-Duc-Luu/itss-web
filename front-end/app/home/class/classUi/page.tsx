...
const Page = () => {
    return (
        <div className="flex w-full flex-col py-10 px-16">
            <div className="mb-5 border-b-[1px] border-slate-200 pb-5">
            ...
            <div className="w-1/5 flex flex-col gap-5">
                <h1 className="tracking-wide uppercase text-gray-500 font-bold text-sm">Invite class id</h1>
                <div className="flex gap-5 w-full">
                    <h1 className="bg-white px-5 py-2 rounded-lg border-2 border-gray-700 w-3/4">#12345</h1>
                    <button className="rounded-lg px-5 py-2 bg-cyan-400 hover:bg-cyan-300 font-semibold text-sm">Copy</button>
                </div>
                <div className="flex flex-col gap-5">
                    <h1 className="tracking-wide uppercase text-gray-500 font-bold text-sm">Class detail</h1>
                    <div className="flex gap-5 font-semibold leading-loose"><School /> Class name</div>
                    <div className="flex gap-5 font-semibold leading-loose"><FlashCard size={25}/> 3 collections</div>
