  ...
  <Card className=' pl-4 pr-4 pt-4 pb-8 ml-4 mr-4 mt-4 mb-4 grid grid-rows-1 gap-0 '>
    ...
    <div className=' grid grid-cols-4 '>
      <Card className="h-[100px] ml-2 mr-1">
        <CardHeader>
          ...
          <CardDescription className='text-lg font-bold'>9999999</CardDescription>
        </CardHeader>
      </Card>
    ...
    <Card className=" min-h-[500px] ml-2 mr-1">
        <CardHeader>
          ...
          <CardDescription className='text-lg font-bold'>gr</CardDescription>
        </CardHeader>
      </Card>
      ...
      <Card className=" min-h-[100px] ml-2 mr-1">
        <CardHeader>
          ...
          <CardDescription className='text-lg font-bold'>username</CardDescription>
        </CardHeader>
      </Card>
    </div>
  </Card>
