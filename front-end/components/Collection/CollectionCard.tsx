function CollectionCard({collection}) {
  return (
    <div className="w-1/3 h-48 border-[1px] border-slate-400 rounded-xl px-10 py-5 shadow-md flex flex-col justify-between hover:border-b-4 hover:border-b-sky-700">
        <div>
