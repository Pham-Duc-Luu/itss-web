  ...
  return (
    <div className="w-full rounded-lg shadow-md bg-white">
      ...
      <div className='flex gap-10 px-10 pb-5'>
        <div className='w-1/2'>
          <CreateCollectionInput label="Word" placeholder="Word" name={word.word} defaultValue={word.word}/>
        </div>
        <div className='w-1/2'>
          <CreateCollectionInput label="Definition" placeholder="Definition" name={word.meaning} defaultValue={word.meaning}/>
        </div>
      </div>
    </div>
  )
